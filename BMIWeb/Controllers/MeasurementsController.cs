...
namespace BMIWeb.Controllers
{
    public class MeasurementsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Date,Weight,Height")] Measurement measurement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Date,Weight,Height")] Measurement measurement)
        {
